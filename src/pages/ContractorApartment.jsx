...
import Contractor from  "../assets/images/contractorImg.png"
    ...
    return (
        <div className='flex flex-col gap-10'>
            <section className="h-screen relative flex flex-col items-center justify-center bg-cover bg-center"
                ...
                style={{
                    backgroundImage: `url(${ContractorImage})`
                }}
            >
                ...
                <div className="h-60 w-4/5 text-center flex flex-col items-center justify-around gap-1 md:gap-4 text-white top-2 md:top-20 z-30">
                    <div className=" w-full md:w-2/3 flex flex-col gap-0 md:gap-4">
                        <h2 className="font-[poppins] font-semibold text-xl md:text-5xl text-center  md:leading-[74px] space-y-6 capitalize tracking-normal align-middle">Contractor Apartments</h2>
                    </div>
            ...
            <div className="h-fit lg:h-96 w-full lg:w-4/5 mx-0 lg:mx-auto flex flex-col lg:flex-row items-center p-2 gap-12 mb-4">
                <div className="h-fit lg:h-96 flex p-2 flex-col gap-8 w-full lg:w-3/4">
                    <div className="flex p-2 items-center justify-between"> 
                        <h2 className="text-[#333] font-semibold text-lg lg:text-3xl leading-10 not-italic">Apartment for Contractors</h2>
                    </div>
            ...
            <div>
                <HomeAminities
                    heading="Facilites you Enjoy in Our Contractor Apartments" 
            ...
            <div className="w-full px-6 py-10">
                <RecentlyApartment 
                    heading="Work-Ready Apartments for Contractor Travelers" 
                    description="Stay productive with modern amenities, reliable Wi-Fi, and convenient access to key business districts." 
                />
            </div>
...
export default ContractorApartment